...
VOID	ItemTable::InitWhiteItemTable()
{
	...
	for(INT i =0;i<iTableCount;i++)
	{
		...
		m_pCommonEquipTableData[i].m_ReqLevel				= 		ThirdFile.Search_Posistion(i,TBReqLevel)->cValue;
...
VOID	ItemTable::InitBlueItemTable()
{
	...
	for(INT i =0;i<iTableCount;i++)
	{
		...
		m_pBlueEquipTableData[i].m_ReqLevel				= 		ThirdFile.Search_Posistion(i,TBReqLevel)->cValue;
		...
		BYTE iMaxGem = ThirdFile.Search_Posistion(i,TBMaxGem)->iValue;
...
VOID	ItemTable::InitGemInfoTable()
{
	...
	for(UINT i = 0;i<m_nGemCount;i++)
	{
		...
		m_pGemInfoData[i].m_ResourceID			= ThirdFile.Search_Posistion(i,TBResID)->wValue;
...
VOID	ItemTable::InitStoreMapTable()
{
	...
	for(UINT i = 0 ;i<m_nStoreMapCount;i++)
	{
		...
		m_pStoreMapData[i].m_ResourceID			=	ThirdFile.Search_Posistion(i,TBResourceID)->wValue;
